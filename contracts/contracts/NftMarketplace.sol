...
contract NftMarketplace is ReentrancyGuard {
    ...
    //----------------- State variables -------------------
    mapping(address => mapping(uint256 => Listing)) private s_listings; // NFT Contract Address -> NFT TokenID -> Listing
    ...
    function buyItem(
        ...
        delete (s_listings[nftAddress][tokenId]);
        IERC721(nftAddress).safeTransferFrom(listedItem.seller, msg.sender, tokenId); // always change state before calling external code
